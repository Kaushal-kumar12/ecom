...
const FilterSidebar = () => {
    ...
    return (
        <div className='p-4'>
            ...
            {/* price Range Filter */}
            <div className='mr-8'>
                <label className='block to-gray-600 font-medium mb-2'>Price Range</label>
                <input
                type='range'
                name='priceRange'
                min={0}
                ...
                <div className='flex justify-between to-gray-600 mt-2'>
                    <span>$0</span>
