...
const Checkout = () => {
    ...
    const handleCreateCheckout = async (e) => {
        ...
        if(cart && cart.products.length > 0) {
            ...
            if(res.payload && res.payload._id) {
                setCheckoutId(res.payload._id); // set checkoutId if checkout was successfull
            }
        }
    };
    ...
    return (
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl ms-auto my-10 px-1 pr-8 tracking-tighter'>
            {/* Left Section */}
            <div className='bg-white rounded-lg p-6'>
                <h2 className='text-2xl uppercase mb-6'>Checkout</h2>
                <form onSubmit={handleCreateCheckout}>
                    <h3 className='text-lg mb-4'>Contack Details</h3>
                    <div className='mb-4'>
                    ...
                    <div className='mt-6'>
                        {!checkoutId ? (
                            <button type='submit' className='w-full bg-black text-white py-3 ronded'>
